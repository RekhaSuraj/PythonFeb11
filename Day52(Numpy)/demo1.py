...
# NumPy (Numerical Python) is a Python library used for working with arrays, numerical data, and mathematical
# operations efficiently.

# Features :
# Numpy is a super fast written in C.
# Supports multi-dimensional arrays (1D, 2D, 3D, etc.)
# It is the foundation of scientific computing in Python and is widely used in data science, machine learning, AI,
...
# Command is : pip install numpy
# or From Settings of the project

# After install, we have to give
import numpy